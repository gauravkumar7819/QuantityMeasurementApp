...
{
    var w1 = new QuantityWeight(a, WeightUnit.KILOGRAM);
    var w2 = new QuantityWeight(b, WeightUnit.KILOGRAM);
    return w1.Equals(w2);
}

public static bool AreGramsEqual(double a, double b)
{
    var w1 = new QuantityWeight(a, WeightUnit.GRAM);
    var w2 = new QuantityWeight(b, WeightUnit.GRAM);
    return w1.Equals(w2);
}

public static bool ArePoundsEqual(double a, double b)
{
    var w1 = new QuantityWeight(a, WeightUnit.POUND);
    var w2 = new QuantityWeight(b, WeightUnit.POUND);
    return w1.Equals(w2);
}

public static bool AreWeightsEqual(double v1, WeightUnit u1, double v2, WeightUnit u2)
{
