...
namespace QuantityMeasurement.Tests
{
    ...
    public class LengthTests
    {
        ...
        {
            bool result =  _service.AreLengthsEqual(1.0, LengthUnit.FEET, 12.0, LengthUnit.INCHES);
        ...
        {
            bool result =  _service.AreLengthsEqual(1.0, LengthUnit.FEET, 11.0, LengthUnit.INCHES);
